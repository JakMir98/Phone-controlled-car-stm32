 ...
 * Enable TIM1 clock
 * Set alternate mode on pins PA8, PA9 and PA10 for channel1, channel2 and channel3
...
void PWM_INIT(void)
{
	...
	TIM1->CCR1 = 0;       // Start value for channel 1
	TIM1->CCR2 = 0;        // Start value for channel 2
	TIM1->CCR3 = 0;        // Start value  for channel 3
